...
4. In Destination tab **select** 'New table' and provide the name as 'thermostat'and then click on 'enlarge' icon.

    ![Close the browser.](media/demo-36.png)

5. In the data Source tab of 'Event Hub' **select** 'create new connection'
...
12. Upon clicking on 'Save', the below disabled fields 'Data connection name' & 'Consumer group' will be enabled. from the Consumer group dropdown select value as default, **click** 'Next: Schema' button.

    ![Close the browser.](media/demo-40.png)

13. On Schema tab, **select** the Data format as JSON and **click** 'Finish' button.
...
19. To create a Query Set **go to** current Workspace, **click** '+ New' and **click** 'Show all' button or more options.
