# Sustainability Deployable PoC Accelerator Setup Guide
...
5. On the 'Create a resource group' screen, **select** your desired subscription. For Resource group, **type** 'DPoC-Sustainability-Lab'. 
...
4. Then **click** on the 'Create a workspace' tab.
	...
	> **Note:** Please create a Workspace by the name "DPoC-Sustainability".
...
3. **Select** the resource group name **DPoC-Sustainability-Lab** which you created in [Task 1](#task-1-create-a-resource-group-in-azure).
...
17. You will now be prompted to **enter** the resource group name in the Azure Cloud Shell. Type the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure). – 'DPoC-Sustainability-Lab'.
...
> **Note:** The setup for your Deployable PoC Accelerator is done here and now you can follow the demo script for testing/demonstrating your environment.
...
4. You will now be prompted to **enter** the resource group name to be deleted in the Azure Cloud Shell. Type the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure) - 'DPoC-Sustainability-Lab'.
