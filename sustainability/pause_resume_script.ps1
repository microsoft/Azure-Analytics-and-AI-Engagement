...
Stop-AzStreamAnalyticsJob -ResourceGroupName $rgName -Name $asa_name_sustainability 
...
az webapp stop --name $sites_iotsustainability_name --resource-group $rgName
az webapp stop --name $sites_airquality_name --resource-group $rgName
