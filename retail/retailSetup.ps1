...
$app_immersive_reader_retail_name = "immersive-reader-retail-app-$suffix";
...
$zips = @("immersive-reader-app", "retaildemo-app", "app-iotfoottraffic-sensor", "app-taxcollection-realtime", "app-vat-custsat-eventhub")
foreach($zip in $zips)
{
