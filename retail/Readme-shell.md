# Retail2.0 Deployable PoC Accelerator Setup Guide
...
5. On the 'Create a resource group' screen, **select** your desired Subscription. For Resource group, **type** 'DPoC-Retail-Lab'. 
...
4. Then **click** on the 'Create a workspace' tab.
	...
	> **Note:** Please create a Workspace by the name "DPoC-Retail".
...
3. **Select** the resource group name **DPoC-Retail-Lab** which you created in [Task 1](#task-1-create-a-resource-group-in-azure).
...
17. You will now be prompted to **enter** the resource group name in the Azure Cloud Shell. Type the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure). – 'DPoC-Retail-Lab'.
...
4. You will now be prompted to **enter** the resource group name to be deleted in the Azure Cloud Shell. Type the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure) - 'DPoC-Retail-Lab'.
...
6. You will now be prompted to **enter** the resource group name in the Azure Cloud Shell. Type the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure). – 'DPoC-Retail-Lab'.
