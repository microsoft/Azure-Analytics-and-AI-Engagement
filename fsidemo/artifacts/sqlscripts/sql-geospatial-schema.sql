ALTER DATABASE [db-geospatial-dev] SET COMPATIBILITY_LEVEL = 150
GO
ALTER DATABASE [db-geospatial-dev] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET ARITHABORT OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [db-geospatial-dev] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [db-geospatial-dev] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO
ALTER DATABASE [db-geospatial-dev] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [db-geospatial-dev] SET READ_COMMITTED_SNAPSHOT ON 
GO
ALTER DATABASE [db-geospatial-dev] SET  MULTI_USER 
GO
ALTER DATABASE [db-geospatial-dev] SET ENCRYPTION ON
GO
ALTER DATABASE [db-geospatial-dev] SET QUERY_STORE = ON
GO
ALTER DATABASE [db-geospatial-dev] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 100, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
...
GO
ALTER DATABASE [db-geospatial-dev] SET  READ_WRITE 
GO
