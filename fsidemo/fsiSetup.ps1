...
$ht.add("#MSCIBeforeReportId#", $($reportList | where {$_.name -eq "MSCI Report"}).id)
$ht.add("#MSCIAfterReportId#", $($reportList | where {$_.name -eq "MSCI Report"}).id)
$ht.add("#ESGReportId#", $($reportList | where {$_.name -eq "ESG Report Synapse Import Mode"}).id)
$ht.add("#fc_reportId#", $($reportList | where {$_.name -eq ""}).id)
