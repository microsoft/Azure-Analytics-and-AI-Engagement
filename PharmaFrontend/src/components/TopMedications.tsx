...
const TopMedications: React.FC = () => {
  const products = useSelector((state: RootState) => state.medications.products);
  const topMeds = products.slice(4, 8);

  if (topMeds.length === 0) return null;

  return (
    <section className="py-10 sm:py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Most Popular</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            The medications and health products our customers trust most.
          </p>
        </div>
