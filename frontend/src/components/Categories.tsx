...
import paintSprayerImg from '../assets/paint-sprayer.webp';
import wallPuttyImg from '../assets/wall-putty.png';
import wallPaintImg from '../assets/wall-paint.jpg';
import paintBrushImg from '../assets/paint-brush.jpg';
import primerImg from '../assets/primer.webp';
import rollersImg from '../assets/rollers.jpg';
import painterstapeImg from '../assets/painter-tape.jpg';
import sandpaperImg from '../assets/sand-paper.webp';
...
const Categories: React.FC = () => {
  ...
  const categoryImages: Record<string, string> = {
    'All': wallPaintImg,
    'Wall Paints': wallPaintImg,
    'Paint Sprayer': paintSprayerImg,
    'Wall Putty': wallPuttyImg,
    'Paint Brush': paintBrushImg,
    'Primer': primerImg,
    'Rollers': rollersImg,
    "Painter's Tape": painterstapeImg,
    'Sandpaper': sandpaperImg,
  };

  // Expanded Zava categories
  const zavaCategories = [
    'All',
    'Wall Paints',
    'Paint Sprayer',
    'Wall Putty',
