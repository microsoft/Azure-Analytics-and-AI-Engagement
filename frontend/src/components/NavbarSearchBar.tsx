...
const NavbarSearchBar: React.FC = () => {
  ...
  // Show results when input changes and input is focused
  useEffect(() => {
  ...
  return (
    <div ref={searchRef} className="relative w-full">
      ...
      {showResults && inputValue.trim() && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-xl z-[60] max-h-96 overflow-y-auto">
