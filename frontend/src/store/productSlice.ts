...
>(
  ...
  async (params, { getState }) => {
    ...
    try {
      // Try new API first
      const response = await axios.get('http://zava-services:3000/data');
      if (response.data && response.data.success && Array.isArray(response.data.data)) {
        // Map API data to Product[]
        const apiProducts: Product[] = response.data.data.map((item: any) => ({
          id: String(item.id),
          name: item.name,
          ...
          images: item.images || [],
          inStock: (typeof item.inStock === 'number') ? item.inStock > 0 : !!item.inStock,
          rating: item.rating ?? 4.5,
          reviews: item.reviews ?? 10,
          featured: !!item.featured,
        }));
        // Optionally filter, sort, and paginate as per query
      ...
      // If API response is not as expected, fallback to dummy
      ...
      const dummyProducts: Product[] = [
        ...
        },
        {
          ...
          price: 47.99,
          originalPrice: undefined,
          description: 'Imagine a gentle breeze carrying the soft hues of a whispering blue, reminiscent of a tranquil sky at dawn.',
          specifications: {},
          images: ['https://dreamdemoassets.blob.core.windows.net/herodemos/furniturehardwoodflooragainstbluewallV1.png'],
          inStock: 100 > 0,
          rating: 4.5,
          reviews: 10,
          featured: false,
        ...
        {
          id: '16',
          name: 'Vibrant Sunshine Yellow',
          category: 'Zava',
          price: 15.99,
          originalPrice: undefined,
          description: 'Imagine a sunshine yellow hue that wraps around you like a warm summer, reminiscent of a serene summer morning.',
          specifications: {},
          images: ['https://dreamdemoassets.blob.core.windows.net/herodemos/closeupspraybottle_v1.png'],
          inStock: 100 > 0,
          rating: 4.5,
          reviews: 10,
          featured: false,
        },
        {
          ...
          price: 46.99,
          originalPrice: undefined,
          description: 'Imagine a frosted blue hue that wraps around you like a cool breeze, reminiscent of a serene winter morning.',
          specifications: {},
          images: ['https://staidemodev.blob.core.windows.net/hero-demos-hardcoded-chat-images/figmaimages/Frosted%20Blue.png'],
          inStock: 100 > 0,
          rating: 4.5,
          reviews: 86,
          featured: false,
        },
        {
          ...
          price: 75.99,
          originalPrice: undefined,
          description: 'OM-403 A sparkling, uplifting jade green for spaces brimming with vitality.',
          specifications: {},
          images: ['https://staidemodev.blob.core.windows.net/hero-demos-hardcoded-chat-images/figmaimages/jade-color-interior-design.png'],
          inStock: 100 > 0,
          rating: 4.5,
          reviews: 90,
          featured: false,
