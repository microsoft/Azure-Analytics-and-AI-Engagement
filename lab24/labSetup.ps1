...
$sql_administrator_login_password = Read-Host "Enter the password for SQL administrator (must be at least 8 characters, including uppercase, lowercase, numbers and symbols)" -AsSecureString | ConvertFrom-SecureString -Force
